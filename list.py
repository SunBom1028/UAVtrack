...
"}\n"
"")
        self.label_listname = QtWidgets.QLabel(Form)
        self.label_listname.setGeometry(QtCore.QRect(10, 10, 581, 31))
        font = QtGui.QFont()
        font.setFamily("幼圆")
        ...
        font.setPointSize(14)
        item.setFont(font)
        self.tableWidget_list.setHorizontalHeaderItem(4, item)
        self.tableWidget_list.horizontalHeader().setDefaultSectionSize(110)
...
"}")
    ...
    def retranslateUi(self, Form):
        ...
        self.label_listname.setText(_translate("Form", "aaaaa"))
        ...
        item = self.tableWidget_list.horizontalHeaderItem(4)
